...
import static com.bilgeadam.exception.ErrorType.BAD_REQUEST;
import static com.bilgeadam.exception.ErrorType.INTERNAL_ERROR;
...
/*
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerAuthMicroseviceException(CompanyMicroserviceException exception){
        return new ResponseEntity<>(createErrorMessage(exception,exception.getErrorType()), BAD_REQUEST);
    }
